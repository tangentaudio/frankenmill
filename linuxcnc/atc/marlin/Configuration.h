...
#define STRING_CONFIG_H_AUTHOR "tangentaudio@gmail.com" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "FMX3-ATC"
...
#define Y_DRIVER_TYPE  A4988   // Unused — required placeholder for axis slot 2 (I axis needs slots 1-3)
#define Z_DRIVER_TYPE  A4988   // Unused — required placeholder for axis slot 3
 ...
 */
#ifdef I_DRIVER_TYPE
  #define AXIS4_NAME 'C' // :['A', 'B', 'C', 'U', 'V', 'W']  — Carousel rotation
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 160 }  // X(mm), Y(unused), Z(unused), I/C(steps/deg)
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 750, 5, 5, 750 }  // X(mm/s), Y(unused), Z(unused), I/C(deg/s)
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 100, 100, 2000 }  // X, Y(unused), Z(unused), I/C
 ...
 */
#define DEFAULT_ACCELERATION          2000    // X, I/C acceleration for moves
#define DEFAULT_RETRACT_ACCELERATION  2000    // E acceleration for retracts (unused)
#define DEFAULT_TRAVEL_ACCELERATION   2000    // X, I/C acceleration for travel moves
...
#define I_ENABLE_ON LOW  // C axis stepper enable
...
#define INVERT_I_DIR false  // C axis direction
...
// :[-1,1]
#define X_HOME_DIR -1
#define Y_HOME_DIR -1  // Unused axis, keep default
#define Z_HOME_DIR -1  // Unused axis, keep default
#define I_HOME_DIR -1  // C axis homes to min
//#define J_HOME_DIR -1
//#define K_HOME_DIR -1
//#define U_HOME_DIR -1
//#define V_HOME_DIR -1
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (4*60), (50*60) }  // X, Y, Z, I/C
